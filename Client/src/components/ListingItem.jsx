...
export default function ListingItem({ listing }) {
    return (
        <div className="bg-white shadow-md w-full sm:w-[330px] md:w-[300px] lg:w-[250px] hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
            <Link to={`/listing/${listing._id}`}>
                <img
                    src={listing.imageUrls[0] || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9OXkYlHqy-Be0XYAWF02n6GbiJRPnMuFIXA&usqp=CAU"}
                    alt='listing cover'
                    className="h-[220px] sm:h-[200px] md:h-[180px] lg:h-[160px] w-full object-cover hover:scale-105 transition-transform duration-300"
                />
